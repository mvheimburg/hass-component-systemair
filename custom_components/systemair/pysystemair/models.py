...
class RegMap():
    ...
    # heat_ex_a0                = InputRegister(addr=14102) # REG_OUTPUT_Y2_ANALOG: Heat Exchanger AO state.
    # heat_ex_d0                = InputRegister(addr=14103) # REG_OUTPUT_Y2_DIGITAL: Heat Exchanger DO state.0: Output not active1: Output active
    # heater_a0                 = InputRegister(addr=14100)# REG_OUTPUT_Y1_ANALOG: Heater AO state.
    # heater_d0                 = InputRegister(addr=14101) # REG_OUTPUT_Y1_DIGITAL: Heater DO state:0: Output not active1: Output active
